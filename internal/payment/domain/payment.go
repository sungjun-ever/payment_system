...
type Payment struct {
	...
	Method PaymentMethod `gorm:"type:varchar(30);not null;column:method"`
	Status PaymentStatus `gorm:"type:varchar(30);not null;default:PENDING;index;column:status"`
