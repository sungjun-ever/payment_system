...
type IdempotencyKey struct {
	...
	Scope  IdempotencyScope `gorm:"type:varchar(255);not null;uniqueIndex:usk;column:scope"`
	...
	Status IdempotencyStatus `gorm:"type:varchar(50);index;not null;column:status"`
