...
func (i *InventoryGormRepository) Store(ctx context.Context, inventory *Inventory) error {
...
func (i *InventoryGormRepository) FindByProductID(ctx context.Context, id uint) (*Inventory, error) {
